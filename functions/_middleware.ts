...
export const onRequest: PagesFunction<Env> = async (context) => {
  ...
  const isBot = /bot|crawler|spider|facebookexternalhit|Twitterbot|LinkedInBot|WhatsApp|Slack|Discord|telegram/i.test(userAgent);
  ...
  try {
    ...
    <meta name="twitter:creator" content="@haasonsaas" />`, { html: true });
        }
      })
      .transform(response);
