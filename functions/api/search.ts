...
function calculateRelevance(query: string, post: Record<string, unknown>): number {
...
const mockBlogPosts = [
  {
    ...
    content: 'I\'ve watched engineering teams slow to a crawl, not because they hired bad developers or chose wrong technologies, but because they treated technical debt like a problem for "future us" to solve...',
  ...
  },
  {
    ...
    description: 'If you\'re feeling like the startup funding landscape has shifted under your feet, you\'re not imagining it. Here\'s a breakdown of why raising a Series A today is tougher.',
    content: 'If you\'re feeling like the ground is shifting under you when it comes to raising a Series A—you\'re right. It has shifted. And it\'s not shifting back anytime soon...',
    tags: ['startup-funding', 'founder-advice', 'venture-capital', 'early-stage', 'growth-strategy'],
    author: 'Jonathan Haas',
    pubDate: '2025-05-12'
  },
  {
    ...
    description: 'Examining why technical founders often confuse early signals with genuine product-market fit, and how to recognize when you\'re building something people truly need',
    content: 'I\'ve spent over a decade building products, working at startups, and watching technical founders (including myself) repeatedly fall into the same traps...',
  ...
  },
  {
    ...
    content: 'The most dangerous thing about startup advice isn\'t that it\'s wrong—it\'s that it\'s partially right...',
    tags: ['leadership', 'personal-growth', 'product-development', 'startups', 'strategy'],
    author: 'Jonathan Haas',
    pubDate: '2024-11-25'
  },
  {
    ...
    content: 'I\'ve watched hundreds of SaaS founders obsess over their LTV:CAC ratio, only to burn through runway because they\'re measuring the wrong things...',
