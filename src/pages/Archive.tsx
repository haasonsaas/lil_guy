          ...
          {viewMode === 'year' ? (
            ...
            years.map(year => (
              <div key={year} className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <Badge variant="secondary">{postsByYear[year].length} articles</Badge>
                </div>
                <div className="space-y-4">
            ...
            months.map(monthYear => (
              <div key={monthYear} className="space-y-6">
                <div className="flex items-center gap-4">
                  <h2 className="text-2xl font-bold">{formatMonthYear(monthYear)}</h2>
                  <Badge variant="secondary">{postsByMonth[monthYear].length} articles</Badge>
                </div>
                <div className="space-y-4">
