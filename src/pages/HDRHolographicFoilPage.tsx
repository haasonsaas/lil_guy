        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card className="bg-gray-900 border-gray-800 p-8">
            ...
            >
              ...
              {/* Sparkle particles */}
              {enableAnimation && Array.from({ length: 20 }).map((_, i) => (
                <motion.div
                  key={i}
            ...
            <div className="mt-6 flex items-center justify-center space-x-4 text-sm text-gray-400">
              <div className="flex items-center space-x-2">
                <div className={`w-3 h-3 rounded-full ${enableHDR ? 'bg-green-500' : 'bg-yellow-500'}`} />
          ...
          <Card className="bg-gray-900 border-gray-800 p-6 space-y-6">
            ...
            <div className="pt-4 border-t border-gray-800">
              ...
              <p className="text-sm text-gray-400 mb-3">
                On HDR-capable displays, this effect uses extended color gamut and brightness 
                values that exceed standard RGB range, creating more vibrant and realistic 
                metallic surfaces.
              </p>
              <Button
                variant="outline"
