  ...
  const features = [
    {
      ...
      description: "Clean JSON responses with consistent schemas and comprehensive metadata"
    },
    {
      icon: <Zap className="w-5 h-5" />,
      title: "Fast & Cached",
      description: "Edge-cached responses with appropriate TTLs for optimal performance"
    },
    {
      icon: <Globe className="w-5 h-5" />,
      title: "CORS Enabled",
      description: "Cross-origin requests supported for client-side applications"
    },
    {
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Programmatic access to all blog content through clean, structured APIs. 
            Built for agents, researchers, and developers.
          </p>
        </div>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Please limit requests to 60/minute per IP. Responses are cached at the edge.
                </p>
              </div>
              <div>
                <h4 className="font-medium mb-2">Attribution</h4>
                <p className="text-sm text-muted-foreground">
                  If using content publicly, please attribute to "Jonathan Haas - Haas on SaaS"
                </p>
              </div>
              <div>
                <h4 className="font-medium mb-2">Caching</h4>
                <p className="text-sm text-muted-foreground">
                  Content updates every 5-60 minutes. Check the "generated" timestamp in responses.
                </p>
              </div>
            </CardContent>
          </Card>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-muted-foreground mb-4">
              If you're building something interesting with this API or need higher rate limits, 
            ...
            <div className="flex gap-3">
              ...
              <Button variant="outline" asChild>
                <a href="/api/posts?limit=1" target="_blank" rel="noopener noreferrer">
                  Test API
                </a>
              </Button>
            </div>
