...
export default function CodeRainPage() {
  ...
  const initializeMatrix = (canvas: HTMLCanvasElement) => {
    ...
    for (let i = 0; i < actualColumns; i++) {
      ...
      const chars = showCode ? snippet.split('') : 
  ...
  const render = (timestamp: number) => {
    ...
    matrixCharsRef.current.forEach((char) => {
      ...
      if (char.y > canvas.height + 100) {
        ...
        const snippet = codeSnippets[Math.floor(Math.random() * codeSnippets.length)];
        char.chars = showCode ? snippet.split('') : 
          '0123456789ABCDEF'.split('').sort(() => Math.random() - 0.5);
      }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Watch your code cascade down the screen Matrix-style. Features real snippets from this very codebase.
            </p>
          </motion.div>
          ...
          >
            <Card className="p-6">
              ...
              <p className="text-sm text-muted-foreground mb-3">
                The falling characters are actual code snippets from this website's codebase, including:
              </p>
            ...
            <Card className="p-6">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li>• <strong>Real Code:</strong> Displays actual snippets from this codebase</li>
                <li>• <strong>Trail Effect:</strong> Characters fade as they fall</li>
                <li>• <strong>Dynamic Columns:</strong> Adjustable density of falling code</li>
                <li>• <strong>Color Themes:</strong> Multiple color schemes to choose from</li>
                <li>• <strong>Binary Mode:</strong> Switch between code and hex characters</li>
              </ul>
            </Card>
          </motion.div>
        </div>
