            ...
            <CardContent className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-3">
                  <h3 className="font-semibold text-gray-900 dark:text-white">What's Available Offline:</h3>
                ...
                <div className="space-y-3">
                  <h3 className="font-semibold text-gray-900 dark:text-white">When Connection Returns:</h3>
                  <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
                    <li className="flex items-center gap-2">
              ...
              <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  <strong>Tip:</strong> Visit blog posts while online to automatically cache them for offline reading. 
                  The service worker will intelligently cache content as you browse.
                </p>
              </div>
            </CardContent>
          </Card>
