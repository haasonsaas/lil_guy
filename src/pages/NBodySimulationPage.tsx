...
const G = 6.6743e-11 * 1e10 // Gravitational constant (scaled for visualization)
...
function NBodySimulationPageContent() {
  ...
  const createBody = useCallback(
    (x: number, y: number, vx: number, vy: number, mass: number): Body => {
  ...
  // Draw gravity field
  const drawGravityField = useCallback(
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="absolute top-4 left-4 text-white text-sm space-y-1 bg-black/50 p-3 rounded">
              ...
              {centerOfMass && bodyCount > 1 && <div>Center of Mass: ✕</div>}
            </div>
