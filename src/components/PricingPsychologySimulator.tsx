...
export default function PricingPsychologySimulator() {
  ...
  const calculateStrategies = useCallback(() => {
    ...
    newStrategies.forEach((strategy) => {
      ...
      finalConversion = Math.max(
        0.5,
        Math.min(finalConversion, baseConversion * 2)
      )

      strategy.conversionRate = Math.round(finalConversion * 100) / 100
      strategy.revenue = Math.round(
        visitors * (strategy.conversionRate / 100) * strategy.price
      )
    })
      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-muted-foreground text-center">
            See how different pricing strategies affect conversion rates and
            revenue
          </p>
        </CardHeader>
        <CardContent>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange('visitors', e.target.value)
                  }
                  placeholder="1000"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange('baseConversion', e.target.value)
                  }
                  placeholder="5.0"
                />
              </div>
              ...
              <div className="space-y-3">
                ...
                <Slider
                  ...
                  onValueChange={(value) =>
                    handleInputChange('pricingSensitivity', value[0])
                  }
                  min={0}
                  max={50}
                  step={1}
              ...
              {getBestStrategy() && (
                <div className="p-4 rounded-lg border bg-gradient-to-r from-primary/10 to-background">
                  ...
                  <div className="text-lg font-bold">
                    {getBestStrategy()?.name}
                  </div>
                  <div className="text-sm text-muted-foreground">
                    ${getBestStrategy()?.revenue.toLocaleString()} monthly
                    revenue
                  </div>
                </div>
              )}
            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              <div className="p-4 rounded-lg border bg-blue-50 dark:bg-blue-950/20">
                ...
                <div className="text-sm space-y-1">
                  <div>
                    • <strong>Left-Digit Bias:</strong> $99 feels much cheaper
                    than $100
                  </div>
                  <div>
                    • <strong>Anchoring:</strong> First price sets reference
                    point for value
                  </div>
                  <div>
                    • <strong>Precision Bias:</strong> Specific prices seem more
                    justified
                  </div>
                  <div>
                    • <strong>Quality Signaling:</strong> Higher prices can
                    increase perceived value
                  </div>
                  <div>
                    • <strong>Loss Aversion:</strong> Showing savings motivates
                    action
                  </div>
                </div>
              </div>
              ...
              <div className="text-xs text-muted-foreground space-y-1">
                <div>
                  • Effects vary by market, product, and customer segment
                </div>
                <div>
                  • A/B testing is essential for validating pricing psychology
                </div>
