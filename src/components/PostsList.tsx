                  ...
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <div className="flex gap-2">
                      {post.frontmatter.featured && (
                        <Badge
                          variant="outline"
                          className="bg-amber-100/50 text-amber-800 border-amber-200"
                        >
                          Featured
                        </Badge>
                      )}
                      {post.frontmatter.draft && (
                        <Badge
                          variant="outline"
                          className="bg-slate-100/50 text-slate-800 border-slate-200"
                        >
                          Draft
                        </Badge>
                      )}
                      ...
                      <TooltipProvider>
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <span>
                              {calculateReadingTime(post.content).minutes} min
                              read
                            </span>
                          </TooltipTrigger>
                          <TooltipContent>
                            <p>
                              Based on{' '}
                              {calculateReadingTime(post.content).wordCount}{' '}
                              words at 200 words per minute
                            </p>
                          </TooltipContent>
                        </Tooltip>
                      </TooltipProvider>
