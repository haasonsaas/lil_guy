...
export const getWebsiteSchema = (): WebsiteSchema => ({
  ...
  name: "Haas on SaaS",
  url: "https://www.haasonsaas.com",
  description: "Expert insights on bridging technical vision with market reality. Learn from a decade of enterprise software experience about AI, vertical SaaS, and building products that can't be ignored.",
...
export const getBlogPostSchema = (post: BlogPost, wordCount: number, readingTimeMinutes: number): BlogPostSchema => {
...
export const injectStructuredData = (schema: PersonSchema | WebsiteSchema | BlogPostSchema) => {
